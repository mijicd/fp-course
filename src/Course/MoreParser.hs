...
-- True
eof :: Parser ()
eof = P (\cs -> if isEmpty cs then Result Nil () else ExpectedEof cs)
...
betweenSepbyComma begin end p = betweenCharTok begin end (sepby p commaTok)

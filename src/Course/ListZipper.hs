...
moveLeftN n z          = moveLeftN (P.pred n) -<< moveLeft z
...
moveRightN n z          = moveRightN (P.pred n) -<< moveRight z
...
instance Applicative ListZipper where
  ...
  (<*>) (ListZipper fl ff fr) (ListZipper l f r) =
    ListZipper (zipWith ($) fl l) (ff f) (zipWith ($) fr r)
...
instance Extend ListZipper where
  (<<=) f z =
    let g z' = (f z', z')
        left = unfoldr ((<$>) g . toOptional . moveLeft) z
        right = unfoldr ((<$>) g . toOptional . moveRight) z
    in ListZipper left (f z) right
